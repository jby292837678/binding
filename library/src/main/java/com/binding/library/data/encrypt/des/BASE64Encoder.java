 ...
 * 
 * This means that the encoded text will simply start with the first line_vertical of
 * encoded text and end with the last line_vertical of encoded text.
 * 
...
public class BASE64Encoder extends CharacterEncoder
{
	...
	/**
	 * this class encodes 57 bytes per line_vertical. This results in a maximum of 57/3 *
	 * 4 or 76 characters per output line_vertical. Not counting the line_vertical termination.
	 */
