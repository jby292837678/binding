...
public abstract class CharacterDecoder
{
	...
	/** Return the maximum number of bytes that can be encoded per line_vertical */
	 ...
	 * been encoded on the line_vertical. 107
	 */
	...
	/**
	 * 113 * This method post processes the line_vertical, if there are error detection
	 * 114 * or correction codes in a line_vertical, they are generally processed by 115
