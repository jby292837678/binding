package com.binding.library.view.edit;//package com.binding.library.view.edit;
//
...
//
////        margin = typedArray.getDimensionPixelOffset(R.styleable.PayPsdInputView_margin,0);
////        marginColor = typedArray.getDimensionPixelOffset(R.styleable.PayPsdInputView_marginColor, Color.GRAY);
//        typedArray.recycle();
//    }
//
//    /**
...
//
////        marginPaint = getPaint(1 ,Paint.Style.FILL,marginColor);
//    }
//
//    /**
//     * 设置画笔
...
////            canvas.drawRect(rectF.left+ margin,rectF.top+ margin,rectF.right- margin,rectF.bottom- margin, marginPaint);
////        }
//
