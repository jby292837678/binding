package com.binding.library.util.location;
...
public class UtilTool {
     ...
     * "address":{"country":"ä¸­å›½","country_code":"CN","region":"ç¦å»ºçœ","city":"ç¦å·žå¸‚",
    ...
    private static void cdma(ArrayList<CellInfo> cellInfos, TelephonyManager tm) {
        @SuppressLint("MissingPermission") CdmaCellLocation location = (CdmaCellLocation) tm.getCellLocation();
