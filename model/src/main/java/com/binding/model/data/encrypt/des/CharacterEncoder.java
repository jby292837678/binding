...
public abstract class CharacterEncoder
{
	...
	/** Return the number of bytes that can be encoded per line_vertical */
	...
	/**
	 * ic_launcher * Encode the suffix for the entire buffer. 97
	 */
	...
	/**
	 * 102 * Encode the prefix that starts every output line_vertical. 103
	 */
	...
	/**
	 * 109 * Encode the suffix that ends every output line_vertical. By default 110 *
	 ...
	 * exhausts the 138 * input stream, but does not print the line_vertical suffix for a
	 * final 139 * line_vertical that is shorter than bytesPerLine(). 140
	 */
	...
	private byte[] getBytes(ByteBuffer bb)
	{
		...
		{
			/*
			 * 232 * This class doesn'model have a concept of encode(buf, len, off),
	 ...
	 * add the 274 * line_vertical at the end of a final line_vertical that is shorter than
	 * bytesPerLine(). 275
	 */
